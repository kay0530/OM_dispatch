      ...
      {recommendation.aiReasoning && (
        <div className="mt-3 pt-3 border-t border-gray-100">
          <div className="flex items-center gap-1.5 mb-1.5">
            ...
            <span className="text-[10px] font-bold text-indigo-600 uppercase tracking-wide">AI推薦理由</span>
          </div>
          <p className="text-xs text-gray-600 leading-relaxed">{recommendation.aiReasoning}</p>
        </div>
      )}
    </div>
  );
